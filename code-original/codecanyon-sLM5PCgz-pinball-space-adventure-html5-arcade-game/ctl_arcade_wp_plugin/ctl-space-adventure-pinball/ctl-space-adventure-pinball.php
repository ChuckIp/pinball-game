<?php
    /*
    Plugin Name: CTL Arcade - Space Adventure Pinball
    Plugin URI: http://www.codethislab.com/
    Description: Car Rush for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSpaceAdventurePinball {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-space-adventure-pinball";
        private $_szPluginName              = "Space Adventure Pinball";
        private $_szAspectRatio             = "3:5";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bar game, pin ball, pinball game, pinball html5, arcade game, classic game, flipper, flíper, flipperen, bin pall, pin, skill game, cabinet, stern pinball, space cadet";
    ...
    $g_oCTLArcadeSpaceAdventurePinball =  new CTLArcadeSpaceAdventurePinball();